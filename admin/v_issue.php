                    ...
                    <table class="table table-striped thead-dark table-bordered table-hover" id="myTable">
                        ...
                        while ($row = mysqli_fetch_array($query)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="v_issue.php?edited=1&idx=<?php echo $row['id']; ?>" data-toggle="modal"
                                        class="btn btn-danger"><span class="fa fa-times"></span> Remove</a> || <a
                                        href="#samstrover<?php echo $row['employee_id']; ?>" data-toggle="modal"
                                        class="btn btn-warning"><span class="fa fa-pencil"></span> View</a>
                                </td>
                            </tr>
                            <?php
