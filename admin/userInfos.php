<div class="modal fade" id="samstrover<?php echo $row['employee_id']; ?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            ?>
            <div class="row">
                <p class="text-center">Employee Id:
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="surname" type="text" class="form-control"
                                value="<?php echo $prow['surname']; ?>" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="province" type="text" class="form-control"
                                value="<?php echo $prow['joined']; ?>" readonly>
                        </div>
                    </div>
                    <div class="line"></div>
                </div>
